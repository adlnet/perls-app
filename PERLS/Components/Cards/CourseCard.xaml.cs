...
namespace PERLS.Components.Cards
{
    ...
    /// A course card.
    /// </summary>
    public partial class CourseCard : BaseCard
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CourseCard"/> class.
        /// </summary>
        public CourseCard()
        {
            InitializeComponent();
        ...
        void OnCanvasViewPaintSurface(object sender, SKPaintSurfaceEventArgs args)
        {
            ...
            var colorTwo = (Color)App.Current.Resources["CourseCardColor"];
