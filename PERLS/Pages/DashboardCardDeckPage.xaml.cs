...
{
    /// <summary>
    /// The Dashboard CardDeckPage.
    /// </summary>
    public partial class DashboardCardDeckPage : BasePage
    {
        bool isPageVisible;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardCardDeckPage"/> class.
        /// </summary>
        public DashboardCardDeckPage()
        {
            InitializeComponent();
        }
        ...
        protected override void OnAppearing()
        {
            ...
            if (BindingContext is DashboardCardDeckViewModel dashboardCardDeckViewModel)
            {
                dashboardCardDeckViewModel.Refresh();
                dashboardCardDeckViewModel.PropertyChanged += OnViewModelPropertyChanged;
            }
        }
        ...
        {
            if (e.PropertyName == nameof(DashboardCardDeckViewModel.Header))
            {
                UpdateHeader();
            }
        }
        ...
        void UpdateHeader()
        {
            ...
            {
                if (BindingContext is DashboardCardDeckViewModel dashboardCardDeckViewModel && dashboardCardDeckViewModel.Header?.Elements.Any() == true)
                {
                    if (Header?.BindingContext != dashboardCardDeckViewModel.Header)
                    {
                        Header = new StackOfCardsCard
                        {
                            BindingContext = dashboardCardDeckViewModel.Header,
                            WidthRequest = (double)Collection.Resources["ItemWidth"],
                        };
