        ...
        public AppCenterAnalytics() : base()
        {
            ...
            Task.Run(async () =>
            {
                ...
                if (crashStatus)
                {
                    ...
                    {
                        { "exceptionName", crashReport?.iOSDetails?.ExceptionName },
                        { "exceptionReason", crashReport?.iOSDetails?.ExceptionReason },
                        { "signal", crashReport?.iOSDetails?.Signal },
                    });
                }
            });
        }
